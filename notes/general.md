...
The first challange a player should tackle is to find out how to get out of these two rooms. It should work in a way that the player focuses more on knowing the mechanics of this world and how to make progress and know themselves rather than the main objective of the game which is finding out who killed Uskar.

Each room has a label. That is not exactly the name of the room but actually a question assigned to that room. The first room's question is "Who killed Uskar?". The second room's question is "How should I get out?" These questions should be designed in a way that when the player comes back to that room It still has meaning, perhaps in a different way. For example the answer to the question of "Who killed Uskar?" will finally be revealed when the player is in the first room. And whenever the player is in the second room they will need to figure out how to get out.
